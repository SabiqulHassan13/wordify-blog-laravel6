...
@section('page-section-title', 'Single Post')

@section('content')
<div class="col-md-12 col-lg-8 main-content">
    <img src="{{ asset('site') }}/images/img_10.jpg" alt="Image" class="img-fluid mb-5">
    <div class="post-meta">
        <span class="author mr-2"><img src="{{ asset('site') }}/images/person_1.jpg" alt="Colorlib" class="mr-2"> Colorlib</span>•
    ...
    <div class="post-content-body">
        ...
        <div class="row mb-5">
            <div class="col-md-12 mb-4">
                <img src="{{ asset('site') }}/images/img_7.jpg" alt="Image placeholder" class="img-fluid">
            </div>
            <div class="col-md-6 mb-4">
                <img src="{{ asset('site') }}/images/img_9.jpg" alt="Image placeholder" class="img-fluid">
            </div>
            <div class="col-md-6 mb-4">
                <img src="{{ asset('site') }}/images/img_11.jpg" alt="Image placeholder" class="img-fluid">
            </div>
        </div>
